<?php /* Smarty version 2.6.25, created on 2014-05-04 13:44:18
         compiled from member_info.tpl */ ?>
...
<table class="allot">
	<tr>
        ...
        <td class="align-left"><?php echo $this->_tpl_vars['user']['user_name']; ?>
</td>
    </tr>
    <tr>
    	<td class="align-right">用户姓名：</td>
        <td class="align-left"><?php echo $this->_tpl_vars['user']['truename']; ?>
</td>
    </tr>
    <tr>
    	<td class="align-right">用户id：</td>
        <td class="align-left"><?php echo $this->_tpl_vars['user']['user_id']; ?>
</td>
    </tr>
...
<div class="table-body allot">
	...
	<input type="hidden" name="user_name" value="<?php echo $this->_tpl_vars['user']['user_name']; ?>
" />
	<input type="hidden" name="user_id" value="<?php echo $this->_tpl_vars['user']['user_id']; ?>
" />
	<input type="hidden" name="truename" value="<?php echo $this->_tpl_vars['user']['truename']; ?>
" />
    	<table class = "table">
			<tr>
...
?>
								<li id='<?php echo $this->_tpl_vars['pi']['pid']; ?>
'><?php echo $this->_tpl_vars['pi']['pname']; ?>
</li>
					...
					<dl class='app'>
						...
						<dd>
							<ul id='appselect'>
								<?php $_from = $this->_tpl_vars['userplist']; if (!is_array($_from) && !is_object($_from)) { settype($_from, 'array'); }if (count($_from)):
    foreach ($_from as $this->_tpl_vars['upi']):
?>
								<li id='<?php echo $this->_tpl_vars['upi']['pid']; ?>
'><?php echo $this->_tpl_vars['upi']['pname']; ?>
</li>
								<?php endforeach; endif; unset($_from); ?>
							</ul>
						</dd>
    ...
    foreach ($_from as $this->_tpl_vars['ri']):
?>
        	<tr>
            	<td class="left"><input type="checkbox" value="chkGroup" name="checkbox" class="checkGroup" onclick="checkGroup(this)" /><?php echo $this->_tpl_vars['ri']['action_name']; ?>
</td>
                <td>
					<?php $_from = $this->_tpl_vars['ri']['priv']; if (!is_array($_from) && !is_object($_from)) { settype($_from, 'array'); }if (count($_from)):
    foreach ($_from as $this->_tpl_vars['rii']):
?>
                	<div class="allotItem"><input type="checkbox" name="action_code[]" value="<?php echo $this->_tpl_vars['rii']['action_code']; ?>
" <?php if (in_array ( $this->_tpl_vars['rii']['action_code'] , $this->_tpl_vars['userright'] )): ?>checked="checked"<?php endif; ?> /><?php echo $this->_tpl_vars['rii']['action_name']; ?>
</div>
					<?php endforeach; endif; unset($_from); ?>
                </td>
            </tr>
