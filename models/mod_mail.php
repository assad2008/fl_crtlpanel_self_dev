...
class mod_mail
{
	...
	{
		self::$from_email = mod_config::get_one_config('fl_fromemail');
		self::$from_name = mod_config::get_one_config('fl_sysname');
		self::$charset = 'utf-8';
	}
	...
	{
		self::$smtp_server = mod_config::get_one_config('fl_smtpserver');
		self::$smtp_port = mod_config::get_one_config('fl_smtpport');
		self::$smtp_ssl = mod_config::get_one_config('fl_smtpssl');
		self::$smtp_auth = mod_config::get_one_config('fl_smtpauth');
		self::$smtp_user = mod_config::get_one_config('fl_smtpid');
		self::$smtp_pwd = mod_config::get_one_config('fl_smtppass');
	}
