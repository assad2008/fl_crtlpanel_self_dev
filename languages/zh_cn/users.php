...
$_LANG['pwd_confirm'] = '密码确认';
$_LANG['old_password'] = '旧密码';
$_LANG['truename'] = '姓名';
$_LANG['password_notic'] = '如果要修改密码,请先填写旧密码,如留空,密码保持不变';
$_LANG['adminlevelname'] = '管理员等级';
$_LANG['rolename'] = '角色名称';
$_LANG['adminuserloginstatus'] = '登陆状态';
$_LANG['userloginz'] = '正常';
$_LANG['userloginb'] = '禁止';
$_LANG['zanwu'] = '暂无';
$_LANG['sendmsg'] = '发送消息';
...
$_LANG['js_languages']['level_empty'] = '请选择管理员等级';
?>
